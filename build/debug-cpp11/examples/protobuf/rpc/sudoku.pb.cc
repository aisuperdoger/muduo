...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 9, -1, sizeof(::sudoku::SudokuRequest)},
  { 10, 20, -1, sizeof(::sudoku::SudokuResponse)},
};
...
class SudokuRequest::_Internal {
 public:
  ...
  static constexpr int32_t kHasBitsOffset =
    8 * PROTOBUF_FIELD_OFFSET(SudokuRequest, _impl_._has_bits_);
...
class SudokuResponse::_Internal {
 public:
  ...
  static constexpr int32_t kHasBitsOffset =
    8 * PROTOBUF_FIELD_OFFSET(SudokuResponse, _impl_._has_bits_);
